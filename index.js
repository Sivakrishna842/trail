...
// }
// catch(err){
// console.log(`Something went wrong while inserting the documenets:${err}`)
// }
...
try {
    ...
    if (findOneResult === null) {
      console.log("Couldn't find any book that contain 'Miguel Grinberg' as an Author.\n");
    } else {
      console.log(`Found a book with 'Miguel Grinberg' as an Author:\n${JSON.stringify(findOneResult)}\n`);
    }
  } catch (err) {
...
try {
    ...
    if (findOneResult === null) {
      console.log("Couldn't find any book that contain '682507' as an id.\n");
    } else {
      console.log(`Found a book with Given id name as:${JSON.stringify(findOneResult.title)}\n`);
    }
  } catch (err) {
    console.error(`Something went wrong trying to find one document: ${err}\n`);
  }
...
try {
  ...
  console.log(`Here is the updated document pages:${JSON.stringify(updateResult.pages)}\n`);
} catch (err) {
